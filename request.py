...
class Request(Message):
    ...
    #         if option.number == defines.OptionRegistry.URI_CFLAG.number:
    ...
    #     option = Option()
    #     option.number = defines.OptionRegistry.URI_CFLAG.number
    #     option.value = cflag
    #     self.add_option(option)
    #     self.uri_cflag = cflag
    ...
    #     """
    #     self.del_option_by_number(defines.OptionRegistry.URI_CFLAG.number)
